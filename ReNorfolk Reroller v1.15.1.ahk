...
LoadSettings() {
    ...
    try {
        ...
        Settings.OCRRegion2.x := Integer(IniRead(SettingsFile, "OCRRegion2", "X", "0"))
        Settings.OCRRegion2.y := Integer(IniRead(SettingsFile, "OCRRegion2", "Y", "0"))
        Settings.OCRRegion2.w := Integer(IniRead(SettingsFile, "OCRRegion2", "W", "0"))
        Settings.OCRRegion2.h := Integer(IniRead(SettingsFile, "OCRRegion2", "H", "0"))
...
SaveSettings() {
    ...
    try {
        ...
        IniWrite(String(Settings.OCRRegion2.x), SettingsFile, "OCRRegion2", "X")
        IniWrite(String(Settings.OCRRegion2.y), SettingsFile, "OCRRegion2", "Y")
        IniWrite(String(Settings.OCRRegion2.w), SettingsFile, "OCRRegion2", "W")
        IniWrite(String(Settings.OCRRegion2.h), SettingsFile, "OCRRegion2", "H")
...
CreateGUI() {
    ...
    MainGui := Gui("+Resize", "ReNorfolk Reroller v1.15")
...
ManualCalibrateNameOCR() {
    global Settings
    
    LogToGUI("=== MANUAL NAME OCR CALIBRATION ===")
    LogToGUI("Opening draggable calibration overlay...")
    LogToGUI("INSTRUCTIONS:")
    LogToGUI("1. Drag and resize the WHITE box over PRIOR LAKE")
    LogToGUI("2. Press ENTER to confirm")
    LogToGUI("3. Press ESC to cancel")
    ...
    ConfirmCalibration(*) {
        ...
        Settings.OCRRegion2.x := currentX
        Settings.OCRRegion2.y := currentY
        Settings.OCRRegion2.w := currentW
        Settings.OCRRegion2.h := currentH
...
WaitForMainMenu(timeout := 120) {  ; 2 minutes timeout
    ...
    Loop {
        ...
        try {
            ...
            captureX := Settings.OCRRegion2.x
            captureY := Settings.OCRRegion2.y
            captureW := Settings.OCRRegion2.w
            captureH := Settings.OCRRegion2.h
